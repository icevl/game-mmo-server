...
func (x *Vector3M) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Vector3M) ProtoMessage() {}

func (x *Vector3M) ProtoReflect() protoreflect.Message {
	mi := &file_proto_global_proto_msgTypes[0]
...
// Deprecated: Use Vector3M.ProtoReflect.Descriptor instead.
func (*Vector3M) Descriptor() ([]byte, []int) {
	return file_proto_global_proto_rawDescGZIP(), []int{0}
}

func (x *Vector3M) GetX() float32 {
	if x != nil {
		return x.X
	}
	return 0
...
var file_proto_global_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x34,
	0x0a, 0x08, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x33, 0x4d, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18,
	...
	0x02, 0x52, 0x01, 0x7a, 0x42, 0x0e, 0x5a, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70,
...
var file_proto_global_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_global_proto_goTypes = []interface{}{
	(*Vector3M)(nil), // 0: messages.Vector3M
}
...
func file_proto_global_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_global_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Vector3M); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
